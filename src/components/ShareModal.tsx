...
import { X, Share2, Copy, Check, MessageCircle, UserPlus } from 'lucide-react';
...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto no-scrollbar">
      <div className="relative w-full max-w-lg bg-[#FAF8F5] rounded-3xl p-6 sm:p-8 border border-[#D4AF37]/40 shadow-2xl space-y-6 text-center my-8">
        <button
          onClick={onClose}
